...
public class ItemRegistry {
    ...
    private void addItems() {
        ItemDTO item1 = new Item("GameBoy", new Amount(2000), "0001", "Console");
        ItemDTO item2 = new Item("Tetris", new Amount(340), "0002", "Game");
        ItemDTO item3 = new Item("Super Mario 2", new Amount(280), "0003", "Game");
        ItemDTO item4 = new Item("Mario figure", new Amount(95), "0004", "Collectable");
        ItemDTO item5 = new Item("Zelda", new Amount(300), "0005", "Game");
        ItemDTO item6 = new Item("AAA batteries", new Amount(19), "0006", "Misc");
